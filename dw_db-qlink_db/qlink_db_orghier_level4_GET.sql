...
****************************************************************************************
DESCRIPTION / NOTES:
- Provides list of MEDICINE organizational divisions
****************************************************************************************
PREREQUISITES:
...
/*  VALIDATION & CLEANUP **************************************************************/
IF OBJECT_ID('qlink_db.orghier_level4_GET','P') IS NOT NULL DROP PROCEDURE qlink_db.orghier_level4_GET;
GO

/*  PROCEDURE CREATION ****************************************************************/
PRINT '** CREATE PROCEDURE';
GO
CREATE PROCEDURE    qlink_db.orghier_level4_GET
                    AS
                    BEGIN
                        BEGIN TRY
                            SELECT      oh4.orghier_level4, 
                                        oh4.orghier_level4_title
                            FROM        qlink_db.orghier_level4 AS oh4
                                        INNER JOIN coa_db.orgnhier_table        AS oh   ON  oh4.orghier_level4 = oh.orgn_code
                            WHERE       oh.orgnhier_level3 IN('JBAA03')
                            GROUP BY    oh4.orghier_level4, 
                                        oh4.orghier_level4_title
                            ORDER BY    oh4.orghier_level4_title
