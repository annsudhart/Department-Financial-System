...
if WITHOUT_APXS and os.name == 'nt':
    ...
    if APACHE_ROOTDIR:
        ...
        # Modify the path here to the location of the Apache24 folder!
        if os.path.exists('c:\\users/ahsudharta/Documents/test-web-server2/Apache24'):
            WITH_WINDOWS_APACHE = 'c:\\users/ahsudharta/Documents/test-web-server2/Apache24'
