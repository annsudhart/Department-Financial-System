...
/*  VALIDATION & CLEANUP **************************************************************/
IF OBJECT_ID('coa_db.orgnhier_table') IS NULL RETURN;
GO

IF OBJECT_ID('coa_db.orgnhier_table_UPD','P') IS NOT NULL DROP PROCEDURE coa_db.orgnhier_table_UPD;
GO
...
CREATE PROCEDURE    coa_db.orgnhier_table_UPD
                    ...
                    BEGIN
                        BEGIN TRY
                            DELETE FROM coa_db.orgnhier_table
                            ...
                            SELECT      dw.orgn_code,
                                        ...
                                        dw.code_8,
                                        dw.refresh_date,
                                        dw.orgnhier_table_id
                            FROM        DW_DB..COA_DB.ORGNHIER_TABLE AS dw
