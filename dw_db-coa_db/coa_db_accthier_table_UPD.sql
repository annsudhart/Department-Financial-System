...
/*  VALIDATION & CLEANUP **************************************************************/
IF OBJECT_ID('coa_db.accthier_table') IS NULL RETURN;
GO
...
CREATE PROCEDURE    coa_db.accthier_table_UPD
                    ...
                    BEGIN
                        BEGIN TRY
                            DELETE FROM coa_db.accthier_table
                            ...
                            SELECT      dw.acct_code,
                                        ...
                                        dw.code_8,
                                        dw.refresh_date,
                                        dw.accthier_table_id
                            FROM        DW_DB..COA_DB.ACCTHIER_TABLE AS dw
