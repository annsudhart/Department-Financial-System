...
EXEC PrintNow '** CREATE [pur].[ec_cardholder_UPD]';
GO
CREATE PROCEDURE    [pur].[ec_cardholder_UPD]
                    ...
                    BEGIN
                        BEGIN TRY
                            ...
                            EXEC PrintNow '-- Find pur.ec_cardholder'
                            IF OBJECT_ID('pur.ec_cardholder','U') IS NULL OR @ResetMe = 9999
                                BEGIN
                                    IF OBJECT_ID('pur.ec_cardholder','U') IS NOT NULL DROP TABLE pur.ec_cardholder
                                    EXEC PrintNow '-- pur.ec_cardholder'
                            ...
                            IF OBJECT_ID('tempdb..#ec_cardholder_UPD','U') IS NOT NULL DROP TABLE tempdb.##ec_cardholder_UPD
                            SELECT  *
                            ...
                            FROM    pur.ec_cardholder AS d
                                    INNER JOIN ##ec_cardholder_UPD AS s ON (
