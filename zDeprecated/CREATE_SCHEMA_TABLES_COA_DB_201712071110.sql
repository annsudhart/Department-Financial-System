...
BEGIN TRY
    ...
    (
        ...
        roll_bdgt_ind               CHAR(1)                         NOT NULL,
        bdgt_dspsn                  CHAR(1)                         NOT NULL,
        encmbr_pct                  DECIMAL(6,3)                    NOT NULL,
        bdgt_jrnl_type              VARCHAR(4)                      NOT NULL,
        bdgt_clsfn                  CHAR(1)                         NOT NULL,
        carry_frwrd_type            CHAR(1)                         NOT NULL,
        bdgt_pct                    DECIMAL(6,3)                    NOT NULL,
        due_to_acct_code            VARCHAR(6)                      NOT NULL,
        due_from_acct_code          VARCHAR(6)                      NOT NULL,
        fund_bal_acct_code          VARCHAR(6)                      NOT NULL,
        ap_acrl_acct_code           VARCHAR(6)                      NOT NULL,
        ar_acrl_acct_code           VARCHAR(6)                      NOT NULL,
        ...
        cmplt_ind                   CHAR(1)                         NOT NULL,
        refresh_date                SMALLDATETIME                   NOT NULL,
...
BEGIN TRY
    ...
    (
        ...
        ucop_fund_number            CHAR(5)                             NULL,
        fund_title                  VARCHAR(35)                     NOT NULL,
        fund_group_code             VARCHAR(6)                      NOT NULL,
...
BEGIN TRY
    ...
    (
        ...
        user_code                   VARCHAR(8)                      NOT NULL,
        unvrs_code                  VARCHAR(2)                      NOT NULL,
        coa_code                    CHAR(1)                         NOT NULL,
        foap_valid_type             VARCHAR(4)                      NOT NULL,
        fund_code                   VARCHAR(6)                      NOT NULL,
        orgn_code                   VARCHAR(6)                      NOT NULL,
        acct_code                   VARCHAR(6)                      NOT NULL,
        prog_code                   VARCHAR(6)                      NOT NULL,
        accttype_code               VARCHAR(2)                      NOT NULL,
        fundtype_code               VARCHAR(2)                      NOT NULL,
        [status]                    CHAR(1)                         NOT NULL,
...
BEGIN TRY
    ...
    (
        ucop_fund_number            VARCHAR(5)                          NULL,
        budgeted_fund_code          CHAR(1)                             NULL,
        fund_restriction_code       CHAR(1)                             NULL,
        method_of_payment           VARCHAR(2)                          NULL,
        endowment_restriction_code  VARCHAR(5)                          NULL,
        ...
        fund_group_code             VARCHAR(6)                          NULL,
        indirect_cost_rate          DECIMAL(10,3)                       NULL,
...
BEGIN TRY
    ...
    (
        ...
        tlphn_area_code             VARCHAR(3)                      NOT NULL,
        tlphn_xchng_id              VARCHAR(3)                      NOT NULL,
        tlphn_seq_id                VARCHAR(4)                      NOT NULL,
        tlphn_xtnsn_id              VARCHAR(4)                      NOT NULL,
