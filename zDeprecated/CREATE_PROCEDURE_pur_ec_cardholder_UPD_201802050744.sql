...
CREATE PROCEDURE    [pur].[ec_cardholder_UPD]
                    ...
                    BEGIN
                        BEGIN TRY
                            ...
                            -- Add records
                            IF OBJECT_ID('tempdb..##ec_cardholder_ADD') IS NOT NULL DROP TABLE tempdb.##ec_cardholder_ADD;
                            SET @SQL = 'SELECT * INTO ##ec_cardholder_ADD FROM ' + 
                                       'OPENQUERY(dw_db, ''SELECT  d.role_key,
                                            d.person_key,
                                            d.card_key,
                                            d.workgroup_key,
                                            d.description,
