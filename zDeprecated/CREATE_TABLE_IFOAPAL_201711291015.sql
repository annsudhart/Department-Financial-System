...
GO
IF OBJECT_ID('ifoapal.account_group_class','U') IS NOT NULL    
    DROP TABLE ifoapal.account_group_class;
GO
...
GO
INSERT INTO ifoapal.account(account_id,account_name,account_level,account_parent_id,account_group_id) VALUES
    (N'ZZZZZZ',N'--EMPTY--',1,NULL,N'ZZ'),
    (N'ZZZZZZ',N'--EMPTY--',2,N'ZZZZZZ',N'ZZ'),
    (N'ZZZZZZ',N'--EMPTY--',3,N'ZZZZZZ',N'ZZ'),
    (N'ZZZZZZ',N'--EMPTY--',4,N'ZZZZZZ',N'ZZ'),
    (N'ZZZZZZ',N'--EMPTY--',5,N'ZZZZZZ',N'ZZ');
GO
...
CREATE VIEW dbo.ifoapal_accounts AS
    SELECT  ifoapal.account.account_id, 
            ...
            ifoapal.account_group.account_class_id,
            ifoapal.account_group_class.account_class_name,
    ...
    FROM    ifoapal.account 
            ...
            INNER JOIN ifoapal.account_group_class 
            ON ifoapal.account_group.account_class_id = ifoapal.account_group_class.account_class_id
